...
test('View two articles created by another users', async ({
  articleWithoutTags,
  articleWithOneTag,
  pages,
  users,
  ...
  await viewArticlePage.followButtonClick();
  ...
  await viewArticlePage.homeButtonClick();

  await homePage.yourFeedTabClick();

  await homePage.assertArticlesInYourFeedCount(2);
});
